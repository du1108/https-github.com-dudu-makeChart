...
public class ChartView extends View {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        if (changed) {
            ...
            height = getHeight();
            //Y轴文本最大宽度
            float textYWdith = getTextBounds("00000", xyTextPaint).width();
            ...
            int dp2 = dpToPx(2);
            int dp3 = dpToPx(3);
            xOri = (int) (dp2 + textYWdith + dp2 + xylinewidth)+dpToPx(5);//dp2是y轴文本距离左边，以及距离y轴的距离
//            //X轴文本最大高度
...
//        super.onDraw(canvas);
    ...
    private void drawBrokenPoint(Canvas canvas) {
        ...
        float dp4 = dpToPx(4);
        float dp7 = dpToPx(7);
        float dp10 = dpToPx(15);
        //绘制节点对应的原点
        for (int i = 0; i < xValue.size(); i++) {
            float x = xInit + interval * i;
            float y = yOri - yOri * (1 - 0.1f) * (value.get(xValue.get(i))-yValue.get(0)) / (yValue.get(yValue.size() - 1)-yValue.get(0));
            //绘制选中的点
            if (i == selectIndex - 1) {
                linePaintXu.setPathEffect(new DashPathEffect(new float[]{4, 4}, 0));//绘制虚线
                Path path = new Path();
                path.moveTo(x, y-dp10);
                path.lineTo(x, yOri);
                canvas.drawPath(path, linePaintXu);
//                linePaint.setStyle(Paint.Style.FILL);
//                linePaint.setColor(0xffff6600);
//                canvas.drawCircle(x, y, dp7, linePaint);
                ...
                linePaint.setStyle(Paint.Style.FILL);
                linePaint.setColor(0xffff6600);
                linePaint.setColor(0xcc000000);
                drawFloatTextBox(canvas, x, y - dp7, value.get(xValue.get(i)), xValue.get(i), i);
//                canvas.drawCircle(x, y, dp4, linePaint);
...
//            canvas.drawCircle(x, y, dp2, linePaint);
     ...
     * @param text
     */
    private void drawFloatTextBox(Canvas canvas, float x, float y, Float text, String addText, int i) {
//        text = addText+"价格："+text+"万元";
        int dp6 = dpToPx(6);
        int dp1 = dpToPx(1);
        int dp3 = dpToPx(3);
        int dp14 = dpToPx(14);
        ...
        if(i == 0){
            //p1
            Path path = new Path();
            path.moveTo(x - dp14, y + dp18);
            path.lineTo(x - dp14, y + dp18 + dp18);
            path.lineTo(x+ dp36+dp18, y + dp18 + dp18);
            path.lineTo(x+ dp36+dp18, y + dp18);
            path.lineTo(x-  dp14, y + dp18);

            canvas.drawPath(path, linePaint);
            linePaint.setColor(Color.WHITE);
            linePaint.setTextSize(spToPx(10));
            Rect rect1 = getTextBounds(addText+"价格:", linePaint);
            Rect rect2 = getTextBounds(text+"", linePaint);
            Rect rect3 = getTextBounds("万", linePaint);
            int widthRect = rect1.width()+rect2.width()+rect3.width();
            canvas.drawText(addText+"价格:", x-dp6 , y + dp35 + (dp18 - rect1.height()) / 2, linePaint);
            linePaint.setColor(0xffff6600);
            canvas.drawText(text+"", x-dp6 +rect1.width(), y + dp35 + (dp18 - rect1.height()) / 2, linePaint);
            linePaint.setColor(Color.WHITE);
            canvas.drawText("万", x-dp6 +rect1.width()+rect2.width(), y + dp35 + (dp18 - rect1.height()) / 2, linePaint);
        }else if(addText.equals("预测月")){
            //p1
            if(text-minYData<1.5){
                Path path = new Path();

                path.moveTo(x- dp36- dp18, y - dp18);
                path.lineTo(x- dp36- dp18, y - dp18 - dp18);
                path.lineTo(x+ dp36+ dp18, y - dp18 - dp18);
                path.lineTo(x+ dp36+ dp18, y - dp18);
                path.lineTo(x- dp36- dp18, y - dp18);
                ...
                linePaint.setColor(Color.WHITE);
                linePaint.setTextSize(spToPx(10));
//            Rect rect = getTextBounds(addText+"价格:"+text+"万", linePaint);
//            canvas.drawText(addText+"价格:"+text+"万", x - 2*rect.width() / 3-dpToPx(9), y - dp6 - (dp18 - rect.height()) / 2, linePaint);
                Rect rect1 = getTextBounds(addText+"价格:", linePaint);
                Rect rect2 = getTextBounds(text+"", linePaint);
                Rect rect3 = getTextBounds("万", linePaint);
                int widthRect = rect1.width()+rect2.width()+rect3.width();
                canvas.drawText(addText+"价格:", x - 2*widthRect / 3-dpToPx(9)-dp3, y - dp18 - (dp18 - rect1.height()) / 2, linePaint);
                linePaint.setColor(0xffff6600);
                canvas.drawText(text+"", x - 2*widthRect / 3-dpToPx(9)+rect1.width(), y - dp18 - (dp18 - rect1.height()) / 2, linePaint);
                linePaint.setColor(Color.WHITE);
                canvas.drawText("万", x - 2*widthRect / 3-dpToPx(9)+rect1.width()+rect2.width(), y - dp18 - (dp18 - rect1.height()) / 2, linePaint);
            }else {

                Path path = new Path();

                path.moveTo(x- dp36- dp18-dp6, y + dp18);
                path.lineTo(x- dp36- dp18- dp6, y + dp18 + dp18);
                path.lineTo(x+ dp36+ dp18, y + dp18 + dp18);
                path.lineTo(x+ dp36+ dp18, y + dp18);
                path.lineTo(x- dp36- dp18-dp6, y + dp18);

//            path.moveTo(x, y);
//            //p2
//            path.lineTo(x - dp6, y - dp6);
//            //p3
//            path.lineTo(x - dp36- dp18, y - dp6);
//            //p4
//            path.lineTo(x - dp36- dp18, y - dp6 - dp18);
//            //p5
...
//            canvas.drawText(addText+"价格:"+text+"万", x - 2*rect.width() / 3-dpToPx(9), y - dp6 - (dp18 - rect.height()) / 2, linePaint);
                ...
                Rect rect3 = getTextBounds("万", linePaint);
                int widthRect = rect1.width()+rect2.width()+rect3.width();
                canvas.drawText(addText+"价格:", x - 2*widthRect / 3-dpToPx(9)-dp3-dp6, y + dp35 + (dp18 - rect1.height()) / 2, linePaint);
                linePaint.setColor(0xffff6600);
                canvas.drawText(text+"", x - 2*widthRect / 3-dpToPx(9)-dp6+rect1.width(), y + dp35 + (dp18 - rect1.height()) / 2, linePaint);
                linePaint.setColor(Color.WHITE);
                canvas.drawText("万", x - 2*widthRect / 3-dpToPx(9)-dp6+rect1.width()+rect2.width(), y + dp35 + (dp18 - rect1.height()) / 2, linePaint);
            }
        }else {
            //p1
            Path path = new Path();

            path.moveTo(x- dp36, y + dp18);
            path.lineTo(x- dp36, y + dp18 + dp18);
            path.lineTo(x+ dp36, y + dp18 + dp18);
            path.lineTo(x+ dp36, y + dp18);
            path.lineTo(x- dp36, y + dp18);
...
//            path.lineTo(x - dp6, y - dp6);
//            //p3
//            path.lineTo(x - dp36, y - dp6);
//            //p4
//            path.lineTo(x - dp36, y - dp6 - dp18);
//            //p5
//            path.lineTo(x + dp36, y - dp6 - dp18);
//            //p6
//            path.lineTo(x + dp36, y - dp6);
...
//            path.lineTo(x, y);
            ...
            Rect rect3 = getTextBounds("万", linePaint);
            int widthRect = rect1.width()+rect2.width()+rect3.width();
            canvas.drawText(addText+"价格：", x - widthRect / 2-dp3, y + dp35 + (dp18 - rect1.height()) / 2, linePaint);
            linePaint.setColor(0xffff6600);
            canvas.drawText(text+"", x - widthRect / 2+rect1.width()+dp3, y + dp35 + (dp18 - rect1.height()) / 2, linePaint);
            linePaint.setColor(Color.WHITE);
            canvas.drawText("万", x - widthRect / 2+rect1.width()+rect2.width()+dp3, y + dp35 + (dp18 - rect1.height()) / 2, linePaint);
        }
    }
    ...
    private void drawBrokenLine(Canvas canvas) {
        List<Cubic> points = new ArrayList<>();
        ...
        float y = yOri - yOri * (1 - 0.1f) * (value.get(xValue.get(0))-yValue.get(0)) / (yValue.get(yValue.size() - 1)-yValue.get(0));
        path.moveTo(x, y);
        ...
        for (int i = 1; i < xValue.size(); i++) {
            x = xInit + interval * i;
            y = yOri - yOri * (1 - 0.1f) * (value.get(xValue.get(i))-yValue.get(0)) / (yValue.get(yValue.size() - 1)-yValue.get(0));
            path.lineTo(x, y);
        ...
        float xxxx1 = xInit + interval*count;
        ...
        float xxxx0 = xInit;
        Cubic cubic3 = new Cubic();
        cubic3.a = xxxx0;
        cubic3.b = yOri;
        points.add(cubic3);

        Shader mShader = new LinearGradient(0,30 + 10,0,getHeight(),new int[] {context.getResources().getColor(R.color.color_ffcdbc),context.getResources().getColor(R.color.color_white)},null,Shader.TileMode.REPEAT);
//新建一个线性渐变，前两个参数是渐变开始的点坐标，第三四个参数是渐变结束的点的坐标。连接这2个点就拉出一条渐变线了，玩过PS的都懂。然后那个数组是渐变的颜色。下一个参数是渐变颜色的分布，如果为空，每个颜色就是均匀分布的。最后是模式，这里设置的是循环渐变
//        lg=new LinearGradient(0,0,100,100,context.getResources().getColor(R.color.color_e55e00),context.getResources().getColor(R.color.color_white), Shader.TileMode.MIRROR);
        lineVerticalPaint.setShader(mShader);
        drawLineBelowBg(canvas, points);
     ...
     * @param points
     */
    private void drawLineBelowBg(Canvas canvas, List<Cubic> points) {
        //p1
        Path path = new Path();
        ...
        //p1
        path.lineTo(points.get(0).a, points.get(0).b);
        canvas.drawPath(path, lineVerticalPaint);

        int count = points.size();
        if(count >= 2){
            Path path2 = new Path();
            path2.moveTo(points.get(count-1).a, points.get(count-1).b);
            path2.lineTo(points.get(count-2).a, points.get(count-2).b);
            canvas.drawPath(path2, bottomLinePaint);
        }
    }
...
//                }
    ...
    private void clickAction(MotionEvent event) {
        ...
        for (int i = 0; i < xValue.size(); i++) {
            ...
            float x = xInit + interval * i;
            float y = yOri - yOri * (1 - 0.1f) * (value.get(xValue.get(i))-yValue.get(0)) / (yValue.get(yValue.size() - 1)-yValue.get(0));
            if (eventX >= x - dp8 && eventX <= x + dp8 && eventY >= y
...
//                        eventY >= y - dp8 && eventY <= y + dp8 && selectIndex != i + 1) {//每个节点周围8dp都是可点击区域
    ...
    public void setValue(Map<String, Float> value, List<String> xValue, List<Integer> yValue) {
        ...
        this.xValue = xValue;
        this.yValue = yValue;
        if(null != yValue && yValue.size()>0)
            minYData = yValue.get(0);
        invalidate();
    }
